...
assert($module_test_1->getFuelRequirement() === 2);

$module_test_2 = new Module(14);
assert($module_test_2->getFuelRequirement() === 2);

$module_test_3 = new Module(1969);
assert($module_test_3->getFuelRequirement() === 654);

$module_test_4 = new Module(100756);
assert($module_test_4->getFuelRequirement() === 33583);
...
while (!feof($day1a_input)) {
    ...
    if (false !== $module_weight) {
        ...
        $fuel = $module->getFuelRequirement();
